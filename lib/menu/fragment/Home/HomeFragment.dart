                               ...
                               child: new Card(
                                   ...
                                   child: new Column(
                                       ...
                                       children: <Widget>
                                         ...
                                         Text("Logged in as Dipu",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),),
                                         ]
                                         ),
                                         ),
                                      Card(
                                       ...
                                       ListTile(
                                         ...
                                         Row(
                                             ...
                                             [
                                               ...
                                               Text("LMS",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),),
                                             ]
                                         ),
                                       ),
                                       Card(
                                     ...
                                     children: <Widget>[
                                       ListTile(
                                         ...
                                         Row(
                                             ...
                                             children: <Widget>
                                             [
                                               Icon(Icons.timeline,size: 40.0,color: Colors.white,),
                                               Text("My TimeSheets",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),),
                                             ]
                                         ),
                                       ),
                                       Card(
                                           ...
                                           child:ListTile(
                                             dense: true,
                                             title: Text("Review My TimeSheet"),
                                           )
                                       ),
                                     ]
                                 ),
                                     ...
                                     children: <Widget>[
                                       ListTile(
                                         ...
                                         Row(
                                             ...
                                             children: <Widget>
                                             [
                                               Icon(Icons.payment,size: 40.0,color: Colors.white,),
                                               Text("Pay Statements",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),),
                                             ]
                                         ),
                                       ),
                                       Card(
                                           ...
                                           child:ListTile(
                                             dense: true,
                                             title: Text("Check My Monthly Payslip"),
                                           )
                                       ),
                                     ]
                                 ),
