            ...
            return AlertDialog(
                      ...
                      builder: (context, snapshot) {
                        if (!snapshot.hasData)
                          ...
                          bankController.value =
                              new TextEditingController.fromValue(
                                      new TextEditingValue(
                                          text: userDocument['bank name']))
                                  .value;
                          accountController.value =
                              new TextEditingController.fromValue(
                                      new TextEditingValue(
                                          text: userDocument['acc no']))
                                  .value;
                          ifsController.value =
                              new TextEditingController.fromValue(
                                      new TextEditingValue(
                                          text: userDocument['ifsc']))
                                  .value;
                          return Container(
                            child: Column(
                              children: <Widget>[
              ...
              actions: <Widget>[
                ...
                new FlatButton(
                    ...
                    onPressed: () {
                      updateData(
                          snapshot.data.uid, "name", nameController.text);
                      updateData(
                          snapshot.data.uid, "bank name", bankController.text);
                      updateData(
                          snapshot.data.uid, "acc no", accountController.text);
