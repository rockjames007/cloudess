                    ...
                    builder: (context, snapshot) {
                      if (!snapshot.hasData)
                        ...
                        if (state == 0) {
                          ...
                          date = userDocument['dob'].toDate();
                        }
                        nameController.value =
                            new TextEditingController.fromValue(
                                    new TextEditingValue(
                                        text: userDocument['mothername']))
                                .value;
                        return Container(
                          height: 280.0,
                          child: Column(
                ...
                new FlatButton(
                    ...
                    onPressed: () {
                      if (date != null) {
                        ...
                        updateData(snapshot.data.uid, "mothername",
                            nameController.text);
